...
OWNER="stashapp"
REPO="stash"
puts "DEBUG: HOMEBREW_STASHAPP_DEVEL_VERSION = #{ENV["HOMEBREW_STASHAPP_DEVEL_VERSION"].inspect}"
puts "DEBUG: STASHAPP_DEVEL_VERSION = #{ENV["STASHAPP_DEVEL_VERSION"].inspect}"
VERSION=ENV["HOMEBREW_STASHAPP_DEVEL_VERSION"] || "0.29.3"
